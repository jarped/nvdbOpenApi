...
class DefaultApi(object):
    ...
    def root_get(self, x_client, **kwargs):  # noqa: E501
        """root_get  # noqa: E501

        List alle resursser  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.root_get(x_client, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.root_get_with_http_info(x_client, **kwargs)  # noqa: E501
        else:
            (data) = self.root_get_with_http_info(x_client, **kwargs)  # noqa: E501
            return data

    def root_get_with_http_info(self, x_client, **kwargs):  # noqa: E501
        """root_get  # noqa: E501

        List alle resursser  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.root_get_with_http_info(x_client, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_client' not in params or
            ...
            raise ValueError("Missing the required parameter `x_client` when calling `root_get`")  # noqa: E501
