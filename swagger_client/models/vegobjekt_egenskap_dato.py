...
class VegobjektEgenskapDato(VegobjektEgenskapBase):
    ...
    def __init__(self, verdi=None, *args, **kwargs):  # noqa: E501
        """VegobjektEgenskapDato - a model defined in Swagger"""  # noqa: E501
        self._verdi = None
    ...
    @property
    def verdi(self):
        """Gets the verdi of this VegobjektEgenskapDato.  # noqa: E501


        :return: The verdi of this VegobjektEgenskapDato.  # noqa: E501
        :rtype: date
        """
        return self._verdi
    ...
    def verdi(self, verdi):
        """Sets the verdi of this VegobjektEgenskapDato.


        :param verdi: The verdi of this VegobjektEgenskapDato.  # noqa: E501
        :type: date
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VegobjektEgenskapDato, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VegobjektEgenskapDato):
            return False
