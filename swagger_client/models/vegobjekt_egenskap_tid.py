...
class VegobjektEgenskapTid(VegobjektEgenskapBase):
    ...
    def __init__(self, verdi=None, *args, **kwargs):  # noqa: E501
        """VegobjektEgenskapTid - a model defined in Swagger"""  # noqa: E501
        self._verdi = None
    ...
    @property
    def verdi(self):
        """Gets the verdi of this VegobjektEgenskapTid.  # noqa: E501


        :return: The verdi of this VegobjektEgenskapTid.  # noqa: E501
        :rtype: str
        """
        return self._verdi
    ...
    def verdi(self, verdi):
        """Sets the verdi of this VegobjektEgenskapTid.


        :param verdi: The verdi of this VegobjektEgenskapTid.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VegobjektEgenskapTid, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VegobjektEgenskapTid):
            return False
